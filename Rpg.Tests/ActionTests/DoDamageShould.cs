...
public class DoDamageShould
{
    ...
    public void ReduceHealthToTargetPlayerByAmount()
    {
        ...
        Assert.Equal(GameConstants.StartHealth - 500, _characterTwo!.Health);
    }
    ...
    public void ToCharacter5LevelsLower_WillIncreaseDamageByhalf()
    {
        ...
        Assert.Equal(GameConstants.StartHealth - 150, lowLevelCharacter!.Health);
    }
    ...
    public void ToCharacter5LevelsHigher_WillDecreaseDamageByhalf()
    {
        ...
        Assert.Equal(GameConstants.StartHealth - 50, highLevelCharacter!.Health);
    }
    ...
    public void NotDoDamageToSelf()
    {
        ...
        Assert.Equal(GameConstants.StartHealth, _characterOne.Health);
    }
    ...
    public void NotDamageOpponentForMeleeFighterIfTargetIsNotWithing2Meters()
    {
        ...
        Assert.Equal(GameConstants.StartHealth - 500, targetCharacter!.Health);
    ...
    public void NotDamageOpponentForRangedFighterIfTargetIsNotWithing20Meters()
    {
        ...
        Assert.Equal(GameConstants.MaxHealth - 500, targetCharacter!.Health);
